...
˗ˏˋ ★ ˎˊ˗ *Configuração auto-sufficiente, ornada e versatil para o tmux — o engenho que, por arte quasi mathematica, multiplica um só terminal em muitos — lavrada com ❤️* ˗ˏˋ ★ ˎˊ˗
...
> **PREFACIO DO AUCTOR — no anno da graça de MDCCCXCVIII**
>
> Apresenta-se á douta congregação dos terminaes este modesto compendio
> sobre o governo do tmux: engenho que, por arte quasi mathematica,
> multiplica um só terminal em muitos e os conserva vivos ainda quando
> d'elles se aparta o observador. A epocha em que vivemos exige da
> machina de calcular tal versatilidade; e não ha sciencia domestica
> mais digna de tractado que a do commando dos proprios terminaes.
>
> A machina aqui exposta NÃO é obra do auctor, senão do preclaro
> engenheiro gpakosz, cuja configuração "Oh my tmux!" se offerece ao
> mundo sob as suas licenças originaes — a WTFPL e a MIT — e cujo
> repositorio se acha em `github.com/gpakosz/.tmux`. Limita-se o auctor
> a apresental-a e ornal-a com a pompa que a materia merece, sem
> alterar-lhe uma só linha do corpo nem subtrahir-lhe credito algum.
>
> ADVERTENCIA AO LEITOR: quanto se segue — requisitos, installação,
> chaves e configurações — guarda-se intacto, tal qual o lavrou o seu
> verdadeiro auctor; que ninguem confunda o humilde commentador com o
> inventor, nem permute as secções sem antes lhes demonstrar a ordem.
>
...
Epilogo do Cathedratico
-----------------------

Ficam assim expostas todas as chaves, variaveis e configurações que
governam esta machina. Se algum erro subsistir na presente edição,
attribua-se ao copista e jámais ao seu verdadeiro auctor — o preclaro
engenheiro gpakosz, cuja obra "Oh my tmux!" se conserva aqui intacta
sob as suas licenças originaes (WTFPL e MIT) — nem tão pouco á
mathematica, que é infallivel.

Que o leitor, doravante senhor de muitos terminaes num só, os governe
com a serenidade de quem maneja uma sciencia exacta; e, sempre que a
machina se mover, que a compile.

Dado no gabinete do auctor, sob a luz do candieiro a gaz, no anno da
graça de MDCCCXCVIII.
